...
export default function PortfolioClientPage({ initialProjects }: { initialProjects: Project[] }) {
          ...
          <TableBody>
            {projects.map((project) => (
              <TableRow key={project.id}>
                <TableCell>
                    <Image src={project.imageUrl || 'https://placehold.co/100x100.png'} alt={project.title} width={40} height={40} className='rounded-md' />
                </TableCell>
